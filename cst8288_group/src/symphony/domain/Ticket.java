...
public class Ticket {
	 ...
	 */
	public Ticket(){
		this(new ScheduledConcert(), 0.0d);
	}
	 ...
	 */
	public Ticket(ScheduledConcert concert, double ticketprice){
	 ...
	 * @param concert - The concert that the ticket is for
	 */
	public void setConcert(ScheduledConcert concert) {
		this.concert = concert;
	}
	 ...
	 */
	private ScheduledConcert concert;
